...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    DynamicConfigForm: typeof import('./components/plugin/DynamicConfigForm.vue')['default']
...
// For TSX support
declare global {
  const ActionHeader: typeof import('./components/common/ActionHeader.vue')['default']
  const CancelConfirmDialog: typeof import('./components/common/CancelConfirmDialog.vue')['default']
  const DynamicConfigForm: typeof import('./components/plugin/DynamicConfigForm.vue')['default']
  ...
  const EnProcess: typeof import('./components/EnProcess.md')['default']
  const MainAsideMenu: typeof import('./components/MainAsideMenu.vue')['default']
  const MainBanner: typeof import('./components/MainBanner.vue')['default']
  const PageHeader: typeof import('./components/PageHeader.vue')['default']
  const PluginPreferenceForm: typeof import('./components/plugin/PluginPreferenceForm.vue')['default']
  const RouterLink: typeof import('vue-router')['RouterLink']
  const RouterView: typeof import('vue-router')['RouterView']
  const ShadowCard: typeof import('./components/ShadowCard.vue')['default']
  const SubPageIndex: typeof import('./components/SubPageIndex.vue')['default']
  const TheFooter: typeof import('./components/TheFooter.vue')['default']
  const ToDocument: typeof import('./components/common/ToDocument.vue')['default']
  const ZhProcess: typeof import('./components/ZhProcess.md')['default']
}